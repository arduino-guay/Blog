...
// M�ximo n� de entradas en el cat�logo
#define MAX_ENTRADAS  15
// N� de caracteres en cada entrada
#define MAX_LONG 20
#define MAX_LONGMAS1 21

// Definici�n de caracteres para el progreso de la canci�n
...
// Variables para conocer la entrada del catalogo actual y anterior, as� como el m�ximo de entradas
byte entrada = 0;
byte entradaA = 0;
byte maxEntradas =  0;
